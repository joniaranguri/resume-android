...
// Profile Section
val profileSection = SingleSection<Profile>(
    data = Profile(
...
// Values Section
val valuesSection = Section<Value>(
    "During my career, I have learnt some valuable lessons from life and work. I want to share with you some of it which I take as my personal values. Guess what: Two of them are values from Blinkist!",
    listOf(
        Value(
            "Channel your inner entrepreneur",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
            "violetCard",
            "https://www.svgrepo.com/show/241783/startup-rocket.svg"
        ), Value(
            "Do work you're proud of",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
            "redCard",
            "https://www.svgrepo.com/show/279473/love-letter-love-and-romance.svg"
        ), Value(
            "Tell the truth and follow through",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
            "greenCard",
            "https://www.svgrepo.com/show/405840/hundred-points.svg"
        ), Value(
            "Work hard and smart",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
            "yellowCard",
            "https://www.svgrepo.com/show/405667/flexed-biceps.svg"
        ), Value(
            "Execute with excellence",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
            "blueCard",
            "https://www.svgrepo.com/show/253940/medal-quality.svg"
        ), Value(
            "To be in Beta continuous",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
            "orangeCard",
...
// Hobbies Section
val hobbiesSection = Section<Hobby>(
    sectionList = listOf(
        Hobby(
            "Reading",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",
            "https://firebasestorage.googleapis.com/v0/b/joniaranguri-resume.appspot.com/o/books.svg?alt=media&token=1e573858-d1f1-4222-bd6f-453531e629ca",
            "greenLight"
        ), Hobby(
            "Running",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",
            "https://www.svgrepo.com/show/397987/person-running-medium-skin-tone.svg",
            "blueLight"
        ), Hobby(
            "Play guitar",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",
            "https://firebasestorage.googleapis.com/v0/b/joniaranguri-resume.appspot.com/o/guitar.svg?alt=media&token=d0cf472a-4b82-4078-a50e-5f2d5864f73a",
            "orangeLight"
        ), Hobby(
            "Programming",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",
            "https://firebasestorage.googleapis.com/v0/b/joniaranguri-resume.appspot.com/o/laptop-idea.svg?alt=media&token=a1c5b87b-df48-430d-99ca-e59f42eb265b",
            "yellowLight"
        )
    )
)
